...
\begin{enumerate}
\item  catterplot could provide a brief idea of that data 
\item  Because the training and test set might come from same distribution, and there might have some relationship between them
\item Validation set is the part of our training data to approximate test error. Test set is provide the true error , and we cannot access it.
